...
Objectifier.prototype = Object.create(stream.Duplex.prototype, {constructor: {value: Objectifier}});

Objectifier.prototype._write = function _write(input, encoding, done) {
...
Objectifier.prototype._read = function _read(n) {};
